...
// this section for middlewere defined
Route::group(['middleware' => 'custom'], function () {
//    Route::get('/', 'IndexController@index');
    Route::get('/', function () {
        return redirect('profile/admin/options');
    });
});
// this section for middlewere defined
...
// for all registered user except 'approve'
Route::group(['middleware' => 'PostEditCreate'], function(){
...
/*** added this line to  add new options poll/quize/video/feed  ****/
Route::get('profile/admin/options', 'UsersController@createOptions');

Route::post("gallerySearch", [
    "uses" => "PostsController@gallerySearch"
]);

Route::get('create',  'PostsController@CreateNew');
Route::post('create',  'PostsController@CreateNewPost');
Route::get('postimages/',  'PostsController@getImagesFromLib');
